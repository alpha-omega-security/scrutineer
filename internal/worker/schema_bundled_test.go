		...
		},
		{
			...
			`{"repository":"https://github.com/o/r","commit":"abc1234","spec_version":13,
			  ...
			  "method":{"scope":"./src","grep_patterns":[{"class":"Memory safety","primitive":"realloc",
			    "command":"grep -rn 'realloc' ./src","hit_count":2,"inventory_sinks":["S1"],
			    "excluded_hits":[{"location":"tests/test_alloc.c:9","category":"test","reason":"Test fixture."}]}],
			    "inventory_count":1,"ruled_out_count":1,"unresolved_count":0},
			  ...
			  "findings":[],"ruled_out":[{"sinks":["S1"],"step":2,"reason":"Bounded by a documented caller invariant."}]}`,
		},
		{
